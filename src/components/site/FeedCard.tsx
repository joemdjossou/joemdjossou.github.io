    ...
    <div className="flex flex-col gap-4 p-4 sm:p-5">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-primary-foreground/85">
          I join your team and own a surface end to end — a mobile app, the API
          behind it, or the pipeline feeding your reporting.
        </p>
      </div>
      ...
      <div>
        ...
        <ul className="mt-2 space-y-1.5 text-sm text-primary-foreground/90">
          {[
            "You need a production app on both stores, not a prototype",
